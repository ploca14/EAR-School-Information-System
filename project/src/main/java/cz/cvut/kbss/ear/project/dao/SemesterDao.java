...
public class SemesterDao extends BaseDao<Semester>{
    ...
    public List<Semester> findByState(SemesterState semesterState){
        try {
            return em.createNamedQuery("Semester.findByState", Semester.class).setParameter("semesterState", semesterState)
                    .getResultList();
    ...
    public Semester findByCode(String code){
        try {
            return em.createNamedQuery("Semester.findByCode", Semester.class).setParameter("code", code)
                    .getSingleResult();
        } catch (NoResultException e) {
            return null;
        }
    ...
    public List<Semester> findByYear(String year){
        try {
            return em.createNamedQuery("Semester.findByYear", Semester.class).setParameter("year", year)
                    .getResultList();
        } catch (NoResultException e) {
            return null;
        }
